...
export type TransactionType =
  ...
  | 'EARN_ACHIEVEMENT' | 'EARN_LOOT_BOX' | 'EARN_WHEEL_SPIN' | 'EARN_MISSION_COMPLETE' | 'EARN_ADMIN_GRANT'
  | 'EARN_TIP'
  | 'DEPOSIT_PAYMONGO' | 'DEPOSIT_PAYPAL' | 'DEPOSIT_CRYPTO'
  | 'SPEND_CAMPAIGN_CREATE' | 'SPEND_CAMPAIGN_BOOST' | 'SPEND_STORE_PURCHASE'
  | 'SPEND_PREMIUM_FEATURE' | 'SPEND_ADMIN_DEDUCT' | 'SPEND_TIP'
  | 'PLATFORM_FEE_CAMPAIGN'
  | 'REFUND_CAMPAIGN_CANCEL' | 'REFUND_COMPLETION_REJECT';
